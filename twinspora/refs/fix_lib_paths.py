"""
Fix library paths in twinspora.kicad_pcb and fp-lib-table.
...
PROJECT = Path(r"D:\gehub\twinspora\twinspora")
PCB = PROJECT / "twinspora.kicad_pcb"
...
report("twinspora.kicad_pcb", pcb_changes, pcb_errors)
...
if apply and total:
    ...
    print("WROTE: twinspora.kicad_pcb, fp-lib-table")
elif not apply:
